...
-- ── carriers ────────────────────────────────────────────────────────────────
-- carriers — espejo del censo FMCSA (145 columnas).
...
CREATE TABLE movik.carriers (
    ...
    "docket3"                      text,
    "pointnum"                     text,
    "total_intrastate_drivers"     bigint,
    "mcsipstep"                    text,
    "mcsipdate"                    text,
    "hm_ind"                       text,
    "interstate_beyond_100_miles"  bigint,
    "interstate_within_100_miles"  bigint,
    "intrastate_beyond_100_miles"  bigint,
    "intrastate_within_100_miles"  bigint,
    "total_cdl"                    bigint,
    "avg_drivers_leased_per_month" bigint,
    "phy_country"                  text,
    "phy_cnty"                     text,
    ...
    "owntrail"                     bigint,
    "owncoach"                     bigint,
    "ownschool_1_8"                bigint,
    "ownschool_9_15"               bigint,
    "ownschool_16"                 bigint,
    "ownbus_16"                    bigint,
    "ownvan_1_8"                   bigint,
    "ownvan_9_15"                  bigint,
    ...
    "trmtrail"                     bigint,
    "trmcoach"                     bigint,
    "trmschool_1_8"                bigint,
    "trmschool_9_15"               bigint,
    "trmschool_16"                 bigint,
    "trmbus_16"                    bigint,
    "trmvan_1_8"                   bigint,
    "trmvan_9_15"                  bigint,
    ...
    "trptrail"                     bigint,
    "trpcoach"                     bigint,
    "trpschool_1_8"                bigint,
    "trpschool_9_15"               bigint,
    "trpschool_16"                 bigint,
    "trpbus_16"                    bigint,
    "trpvan_1_8"                   bigint,
    "trpvan_9_15"                  bigint,
...
-- maestro — el censo completo cruzado con UCC (162 columnas).
